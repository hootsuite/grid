;(function($, window, document, undefined) {
  ...
  DraggableGridList.prototype._snapItemPositionToGrid = function(item) {
    ...
    col = Math.round(position.left / this._cellSize);
    row = Math.round(position.top / this._cellSize);
  ...
  DraggableGridList.prototype._highlightPositionForItem = function(item) {
    this.$positionHighlight.css({
      ...
      left: item.x * this._cellSize,
      top: item.y * this._cellSize
    }).show();
  };
  ...
  DraggableGridList.prototype._calculateCellSize = function() {
    this._cellSize = this.$element.height() / this.options.rows;
    if (this.options.fontSizeRatio) {
      this._fontSize = this._cellSize * this.options.fontSizeRatio;
    }
  };

  ...
  DraggableGridList.prototype = {
    ...
    _initGridList: function() {
      ...
      var options = {
          ...
          columnsPerGroup: this.options.columnsPerGroup
      };

      this.gridList = new GridList(this.items, options);
    },
    ...
    _snapItemPositionToGrid: function(item) {
      ...
      if (this.options.columnsPerGroup) {
        if (col % this.options.columnsPerGroup + item.w > this.options.columnsPerGroup) {

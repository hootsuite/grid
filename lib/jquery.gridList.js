;(function($, window, document, undefined) {
  ...
  DraggableGridList.prototype.bindDragEvents = function() {
    this._onStart = this._bindMethod(this.onStart);
  ...
  DraggableGridList.prototype.onStart = function(event, ui) {
  ...
  DraggableGridList.prototype._getItemWidth = function(item) {
    // FIXME: optimize this
    if (this.options.autoItemSize) {
      var ratio = this.options.itemWidth / this.options.itemHeight;
      return item.w * ((this.$element.height() / this.options.rows));
    } else {
  ...
  DraggableGridList.prototype._getItemHeight = function(item) {
    // FIXME: optimize this
    if (this.options.autoItemSize) {
      return item.h * (this.$element.height() / this.options.rows);
    } else {

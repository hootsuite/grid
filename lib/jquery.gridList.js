;(function($, window, document, undefined) {
  ...
  DraggableGridList.prototype._unbindEvents = function() {
    ...
    this.$element.off('click', '.resize', this._onItemResize);
  };
  ...
  DraggableGridList.prototype._onItemResize = function(e) {
    e.preventDefault();
    var size = $(e.currentTarget).data('size'),
        item = this._getItemByElement($(e.currentTarget).closest('li'));
    item.w = size;
    this.gridList.moveItemToPosition(item, [item.x, item.y]);
    this.render();
  };

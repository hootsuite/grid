var GridList = function(items, options) {
  ...
  this.items = items;
  // TODO: Position item by index if they don't come with 2d position
  // beforehand
  this.createGridFromPositionedItems();
};
...
GridList.prototype.createGridFromPositionedItems = function() {
  this._resetGrid();
...
GridList.prototype.positionItemsByIndex = function() {
  this._resetGrid();
  var currentColumn = 0;
...
GridList.prototype.moveItemToPosition = function(item, position) {
  ...
  // taken in the grid will be cleared
